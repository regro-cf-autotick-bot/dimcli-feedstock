...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dimcli-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14826&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dimcli-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dimcli` can be installed with:

```
conda install dimcli
```

It is possible to list all of the versions of `dimcli` available on your platform with:
